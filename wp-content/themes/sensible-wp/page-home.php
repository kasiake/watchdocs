        	...
        	<div class="social-bar">
        		<div class="grid grid-pad">
                	...
                	<?php if ( get_theme_mod( 'social_text' ) ) : ?>
        			  	<span class="wow animated fadeIn"><?php echo esc_html(get_theme_mod( 'social_text' )); ?></span> 
                	<?php else : ?>  
					<?php endif; ?> 
        		...
        		<div class="grid grid-pad">
        			<div class="col-1-1">
						...
						<?php if ( get_theme_mod( 'intro_text' ) ) : ?>
        			  		<h6 class="wow animated fadeInLeft"><?php echo esc_html(get_theme_mod( 'intro_text' )); ?></h6>
                		<?php else : ?>  
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'intro_textbox' ) ) : ?>
        			  		<p class="wow animated fadeInRight"><?php echo get_theme_mod( 'intro_textbox' ); ?></p>  
                		<?php else : ?> 
						<?php endif; ?>
        	...
        	<div class="home-services">
				...
				<?php if ( get_theme_mod( 'services_text' ) ) : ?>
        			<div class="grid grid-pad">
            			...
            			<div class="col-1-1"><h6 class="wow animated fadeIn"><?php echo esc_html(get_theme_mod( 'services_text' )); ?></h6></div>
					...
					<div class="col-1-3 tri-clear wow animated fadeIn" data-wow-delay="0.25s"> 
                        ...
                        <?php if( get_theme_mod( 'active_service_1' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'service_title_1' ) ) : ?>
              					<h5><?php echo esc_html(get_theme_mod( 'service_title_1' )); ?></h5>
                            <?php endif; ?> 
                            
                            <?php if ( get_theme_mod( 'service_text_1' ) ) : ?>
              					<p class="member-description"><?php echo esc_html(get_theme_mod( 'service_text_1' )); ?></p>
                            <?php endif; ?>
                    ...
                    <div class="col-1-3 tri-clear wow animated fadeIn" data-wow-delay="0.25s"> 
                        ...
                        <?php if( get_theme_mod( 'active_service_2' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'service_title_2' ) ) : ?>
              					<h5><?php echo esc_html(get_theme_mod( 'service_title_2' )); ?></h5>
                            <?php endif; ?> 
                            
                            <?php if ( get_theme_mod( 'service_text_2' ) ) : ?>
              					<p class="member-description"><?php echo esc_html(get_theme_mod( 'service_text_2' )); ?></p>
                            <?php endif; ?> 
    					...
    					<div class="service sbox-3">
                         ...
                         <?php if( get_theme_mod( 'active_service_3' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'service_title_3' ) ) : ?>
              					<h5><?php echo esc_html(get_theme_mod( 'service_title_3' )); ?></h5>
                            <?php endif; ?> 
                            
                            <?php if ( get_theme_mod( 'service_text_3' ) ) : ?>
              					<p class="member-description"><?php echo esc_html(get_theme_mod( 'service_text_3' )); ?></p> 
                            <?php endif; ?> 
        ...
        <?php if( get_theme_mod( 'active_blog' ) == '') : ?> 
        	...
        	<div class="home-news">
				...
				<?php if ( get_theme_mod( 'blog_text' ) ) : ?>
                	<div class="grid grid-pad">
            			<div class="col-1-1">
                    		<h6 class="wow animated fadeIn"><?php echo esc_html(get_theme_mod( 'blog_text' )); ?></h6>
                    	</div><!-- col-1-1 -->  
                    </div><!-- grid -->
                <?php else : ?> 
				<?php endif; ?> 
...
else echo esc_url( home_url() );?>"><button class="outline white"><?php echo esc_html(get_theme_mod( 'blog_cta' )); ?></button></a>  
        				</div><!-- col-1-1 --> 
            		</div><!-- grid -->
        		</div><!-- home-blog-cta -->
        ...
        <?php if( get_theme_mod( 'active_team' ) == '') : ?>   
        	...
        	<div class="home-team">
                ...
                <?php if ( get_theme_mod( 'team_text' ) ) : ?>
                    ...
                    <div class="grid grid-pad">
            			<div class="col-1-1">
                        	<h6 class="wow animated fadeInRight"><?php echo esc_html(get_theme_mod( 'team_text' )); ?></h6>
                        </div><!-- col-1-1 -->  
            		</div><!-- grid -->
					...
					<div class="col-1-3 tri-clear wow animated fadeInLeft" data-wow-delay="0.15s">
                        ...
                        <?php if( get_theme_mod( 'active_member_1' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'member_name_1' ) ) : ?>
              					<h5><?php echo esc_html(get_theme_mod( 'member_name_1' )); ?></h5>
                            <?php endif; ?>
                            
                            <?php if ( get_theme_mod( 'member_text_1' ) ) : ?>
              					<p class="member-description"><?php echo esc_html(get_theme_mod( 'member_text_1' )); ?></p>
                            <?php endif; ?> 
                    ...
                    <div class="col-1-3 tri-clear wow animated fadeInLeft" data-wow-delay="0.15s">
                        ...
                        <?php if( get_theme_mod( 'active_member_2' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'member_name_2' ) ) : ?>
              					<h5><?php echo esc_html(get_theme_mod( 'member_name_2' )); ?></h5>
                            <?php endif; ?>
                            
                            <?php if ( get_theme_mod( 'member_text_2' ) ) : ?>
              					<p class="member-description"><?php echo esc_html(get_theme_mod( 'member_text_2' )); ?></p>
                            <?php endif; ?> 
                    ...
                    <div class="col-1-3 tri-clear wow animated fadeInLeft" data-wow-delay="0.15s">
                        ...
                        <?php if( get_theme_mod( 'active_member_3' ) == '') : ?> 
                            ...
                            <?php if ( get_theme_mod( 'member_name_3' ) ) : ?>
              					<h5><?php echo esc_html(get_theme_mod( 'member_name_3' )); ?></h5>
                            <?php endif; ?>
                            
                            <?php if ( get_theme_mod( 'member_text_3' ) ) : ?>
              					<p class="member-description"><?php echo esc_html(get_theme_mod( 'member_text_3' )); ?></p>
                            <?php endif; ?> 
        ...
        <div class="home-cta" style="background: url(<?php echo esc_url(get_theme_mod( 'widget_bg_image', __( (get_stylesheet_directory_uri( 'stylesheet_directory') . '/img/keyboard-bg.jpg'), 'sensible-wp' ) )); ?>) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">  
			...
			?>
                    ...
                    <?php if ( get_theme_mod( 'widget_button_url' ) ) : ?>  
    					...
    					<a href="<?php echo esc_url( get_page_link( get_theme_mod('widget_button_url')))?>"><button class="outline white"><?php echo esc_html( get_theme_mod( 'widget_button_text' )); ?></button></a> 
