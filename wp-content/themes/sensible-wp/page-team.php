					...
					<div class="col-1-3 tri-clear wow animated fadeInLeft" data-wow-delay="0.15s">
                        ...
                        <?php if( get_theme_mod( 'page_active_member_1' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'page_member_name_1' ) ) : ?>
              					<h5><?php echo esc_html( get_theme_mod( 'page_member_name_1' )); ?></h5>
                            <?php endif; ?>
                            
                            <?php if ( get_theme_mod( 'page_member_text_1' ) ) : ?>
              					<p class="member-description"><?php echo esc_html( get_theme_mod( 'page_member_text_1' )); ?></p>
                            <?php endif; ?> 
                    ...
                    <div class="col-1-3 tri-clear wow animated fadeInLeft" data-wow-delay="0.15s">
                        ...
                        <?php if( get_theme_mod( 'page_active_member_2' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'page_member_name_2' ) ) : ?>
              					<h5><?php echo esc_html( get_theme_mod( 'page_member_name_2' )); ?></h5>
                            <?php endif; ?>
                            
                            <?php if ( get_theme_mod( 'page_member_text_2' ) ) : ?>
              					<p class="member-description"><?php echo esc_html( get_theme_mod( 'page_member_text_2' )); ?></p>
                            <?php endif; ?> 
                    ...
                    <div class="col-1-3 tri-clear wow animated fadeInLeft" data-wow-delay="0.15s">
                        ...
                        <?php if( get_theme_mod( 'page_active_member_3' ) == '') : ?> 
                            ...
                            <?php if ( get_theme_mod( 'page_member_name_3' ) ) : ?>
              					<h5><?php echo esc_html( get_theme_mod( 'page_member_name_3' )); ?></h5>
                            <?php endif; ?>
                            
                            <?php if ( get_theme_mod( 'page_member_text_3' ) ) : ?>
              					<p class="member-description"><?php echo esc_html( get_theme_mod( 'page_member_text_3' )); ?></p>
                            <?php endif; ?> 
