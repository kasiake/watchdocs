        	...
        	<div class="social-bar"> 
        		<div class="grid grid-pad">
                	...
                	<?php if ( get_theme_mod( 'footer_social_text' ) ) : ?>
        			  	<span class="wow animated fadeIn"><?php echo esc_html( get_theme_mod( 'footer_social_text' )); ?></span>
                	<?php else : ?>  
					<?php endif; ?> 
        ...
        <div class="grid grid-pad">
            ...
            <div class="col-1-1">
            	<?php if ( get_theme_mod( 'footer_title_text' ) ) : ?> 
    				<h6><?php echo esc_html( get_theme_mod( 'footer_title_text' )); // footer title ?></h6>
    			<?php else : ?> 
				<?php endif; ?>
            </div><!-- col-1-1 -->
                ...
                <div class="col-1-3">
            		<div class="footer-block">
                    	...
                    	<?php if ( get_theme_mod( 'bottom_footer_icon_1' ) ) : ?> 
    						<i class="fa <?php echo esc_html( get_theme_mod( 'bottom_footer_icon_1', __( 'fa-map-marker', 'sensible-wp' ) )); // first icon ?>"></i>
    					<?php else : ?> 
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'first_text' ) ) : ?> 
    						<h5><?php echo esc_html( get_theme_mod( 'first_text' )); // first icon ?></h5>
    					<?php else : ?>   
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'sensiblewp_footer_first' ) ) : ?> 
    						<p><?php echo esc_html( get_theme_mod( 'sensiblewp_footer_first' )); // first icon ?></p>
    					<?php else : ?>   
						<?php endif; ?>  
            	...
            	<div class="col-1-3">
            		<div class="footer-block">
                        ...
                        <?php if ( get_theme_mod( 'bottom_footer_icon_2' ) ) : ?> 
    						<i class="fa <?php echo esc_html( get_theme_mod( 'bottom_footer_icon_2', __( 'fa-mobile', 'sensible-wp' ) )); // second icon ?>"></i>
    					<?php else : ?> 
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'second_text' ) ) : ?> 
    						<h5><?php echo esc_html( get_theme_mod( 'second_text' )); // second icon ?></h5>
    					<?php else : ?>   
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'sensiblewp_footer_second' ) ) : ?> 
    						<p><?php echo esc_html( get_theme_mod( 'sensiblewp_footer_second' )); // second icon ?></p>
    					<?php else : ?>   
						<?php endif; ?>
            	...
            	<div class="col-1-3">
            		<div class="footer-block">
                        ...
                        <?php if ( get_theme_mod( 'bottom_footer_icon_3' ) ) : ?> 
    						<i class="fa <?php echo esc_html( get_theme_mod( 'bottom_footer_icon_3', __( 'fa-envelope-o', 'sensible-wp' ) )); // third icon ?>"></i>
    					<?php else : ?>
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'third_text' ) ) : ?> 
    						<h5><?php echo esc_html( get_theme_mod( 'third_text' )); // third icon ?></h5>
    					<?php else : ?>   
						<?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'sensiblewp_footer_third' ) ) : ?>  
    						<p><?php echo esc_html( get_theme_mod( 'sensiblewp_footer_third' )); // third icon ?></p>  
    					<?php else : ?>   
						<?php endif; ?>  
    	...
    	<div class="grid grid-pad">
			<div class="site-info col-1-1">
				<?php if ( get_theme_mod( 'sensiblewp_footerid' ) ) : ?> 
        			<?php echo esc_html( get_theme_mod( 'sensiblewp_footerid' )); // footer id ?>
				<?php else : ?>  
