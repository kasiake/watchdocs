					...
					<div class="col-1-3 tri-clear wow animated fadeIn" data-wow-delay="0.25s"> 
                        ...
                        <?php if( get_theme_mod( 'active_page_service_1' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'page_service_title_1' ) ) : ?>
              					<h5><?php echo esc_html( get_theme_mod( 'page_service_title_1' )); ?></h5>
                            <?php endif; ?> 
                            
                            <?php if ( get_theme_mod( 'page_service_text_1' ) ) : ?>
              					<p class="member-description"><?php echo esc_html( get_theme_mod( 'page_service_text_1' )); ?></p>
                            <?php endif; ?>
                    ...
                    <div class="col-1-3 tri-clear wow animated fadeIn" data-wow-delay="0.25s"> 
                        ...
                        <?php if( get_theme_mod( 'active_page_service_2' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'page_service_title_2' ) ) : ?>
              					<h5><?php echo esc_html( get_theme_mod( 'page_service_title_2' )); ?></h5>
                            <?php endif; ?> 
                            
                            <?php if ( get_theme_mod( 'page_service_text_2' ) ) : ?>
              					<p class="member-description"><?php echo esc_html( get_theme_mod( 'page_service_text_2' )); ?></p>
                            <?php endif; ?> 
    					...
    					<div class="service sbox-page-3">
                         ...
                         <?php if( get_theme_mod( 'active_page_service_3' ) == '') : ?>
                            ...
                            <?php if ( get_theme_mod( 'page_service_title_3' ) ) : ?>
              					<h5><?php echo esc_html( get_theme_mod( 'page_service_title_3' )); ?></h5>
                            <?php endif; ?> 
                            
                            <?php if ( get_theme_mod( 'page_service_text_3' ) ) : ?>
              					<p class="member-description"><?php echo esc_html( get_theme_mod( 'page_service_text_3' )); ?></p>
                            <?php endif; ?>
